...
O custo desse fechamento vai além do desconforto de uma conversa pública fragmentada. A circulação de desinformação sobre a Covid-19 no Twitter oferece um exemplo concreto, e grave, do que está em jogo. Recuero, Soares e Zago \cite{b_recuero2021} mostraram que o consumo de informação sobre a pandemia se dividiu de forma assimétrica entre os grupos. De um lado havia um ambiente em que a desinformação aparecia fortemente associada a veículos hiperpartidários e a conteúdo de redes sociais. De outro, um ambiente em que predominavam fontes jornalísticas e institucionais. Foi dentro do primeiro ambiente que circulou a defesa de um tratamento sem eficácia comprovada e a resistência à vacinação, que foi o que de fato conteve a doença. Quando a dieta informativa de um grupo se fecha em torno de fontes que apenas reforçam umas às outras, o que entra ali deixa de ser corrigido pelo que circula fora. No caso da pandemia, esse fechamento teve um custo que pode ser contado em vidas.

O mesmo mecanismo ajuda a entender o caminho até o 8 de janeiro. Para quem acompanhava a eleição imerso em um feed onde praticamente todos apoiavam o mesmo candidato, a derrota nas urnas era difícil de conciliar com a realidade observada todos os dias. Se todos ao redor apoiam um lado, como o outro lado venceu? Vista de dentro dessa bolha, a suspeita de fraude não soa como teoria da conspiração, e sim como a conclusão mais natural diante do que se vê. É aqui que o papel da rede como formadora de realidade deixa de ser apenas uma metáfora. A exposição repetida a uma só versão dos fatos cria as condições para que um resultado legítimo seja lido como roubo, e para que contestar esse resultado pareça um dever.
